...
pub(super) fn simd_element_type(dtype: crate::ast::Dtype) -> Ty {
    match dtype {
...
pub(super) fn slice_descriptor_ty(kind: crate::types::SliceKind) -> Ty {
...
pub(super) fn generic_callable_decls(ty: &Ty) -> Option<&[crate::types::ParamDecl]> {
    match ty {
