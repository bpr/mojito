...
pub(super) fn ct_integer(value: &CtValue) -> Option<crate::literal::IntLiteral> {
    match value {
...
pub(super) fn canonical_generic_signature(
    decls: &[ParamDecl],
    params: &[Ty],
...
/// signature types.
pub(super) fn rename_constraint_parameters(
...
pub(super) fn erase_generic_callable_binders(callable: &Ty) -> Option<(Vec<ParamDecl>, Ty)> {
    let Ty::GenericFunc {
        environment,
        decls,
        params,
...
pub(super) fn seeded_transfer_effects() -> HashMap<String, Vec<crate::checked::TransferEffect>> {
...
pub(super) fn callable_convention_accepts(
...
pub(super) fn contract_transfer_effects(ty: &Ty) -> &[crate::checked::TransferEffect] {
