...
impl Locator {
    pub(in crate::backend::pliron) fn new(
        ctx: &mut Context,
    ...
    pub(in crate::backend::pliron) fn source_labels(&self) -> impl Iterator<Item = &str> {
    ...
    pub(in crate::backend::pliron) fn sources(
        &self,
    ) -> impl Iterator<Item = pliron::location::Source> + '_ {
...
pub(in crate::backend::pliron) fn lower_ty(
    function: &str,
    ty: &Ty,
    layout: &LayoutCx<'_>,
