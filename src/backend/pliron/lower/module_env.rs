...
impl ModuleShared {
    pub(in crate::backend::pliron) fn new(module: ModuleOp) -> ModuleShared {
        ModuleShared {
            module,
    ...
    pub(in crate::backend::pliron) fn declared_rt(&self, symbol: &str) -> bool {
...
pub(in crate::backend::pliron) fn declare_function(
    ctx: &mut Context,
    module: ModuleOp,
    name: &str,
    func: &MirFunction,
...
pub(in crate::backend::pliron) fn synthesize_exe_wrapper(
    ctx: &mut Context,
    module: ModuleOp,
...
pub(in crate::backend::pliron) fn intercepted_call(name: &str) -> bool {
