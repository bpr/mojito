...
- Growth in a store that is not keyed by occurrence refuses it
  (`UnkeyedFact`): nested declaration types and effects, transferred
  origins, deletable declarations.
