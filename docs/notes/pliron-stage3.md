...
generated `conformance/pliron-stage3.tsv` (both superseded by
`parity_exe_manifest_and_differential` over `conformance/pliron-parity.tsv`): every `assets/ok` fixture with a
