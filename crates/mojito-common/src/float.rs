...
mod tests {
    ...
    fn half_precision_lane_rounding_ties_to_even() {
        assert_eq!(round_f16(0.800_048_828_125), 0.799_804_687_5);
        assert_eq!(round_f16(0.300_048_828_125 + 0.5), 0.799_804_687_5);
        assert_eq!(round_f16(65519.99), 65504.0);
        assert_eq!(round_f16(65520.0), f64::INFINITY);
        assert_eq!(round_f16(-70000.0), f64::NEG_INFINITY);
        assert_eq!(round_f16(1e-6), 17.0 * 2f64.powi(-24));
