        ...
        MirInstr::GetIter {
            ...
            &[
                ...
                (
                    "mode",
                    match mode {
                        mojito_checked::checked::IterationMode::Borrowed => "borrowed",
                        mojito_checked::checked::IterationMode::Owned => "owned",
                    }
                    .into(),
                ),
...
fn callable_type(
    ...
    transfers: &mojito_checked::checked::TransferSet,
) -> String {
    record(
        tag,
        &[
...
fn transfer_set(value: &mojito_checked::checked::TransferSet) -> String {
...
fn slice_kind(value: mojito_types::types::SliceKind) -> &'static str {
    match value {
        ...
        mojito_types::types::SliceKind::StridedSlice => "strided_slice",
    }
}
...
fn var_value(value: mojito_hir::hir::VarId) -> String {
    format!("$v{value}")
}
